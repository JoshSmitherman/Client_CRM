            ...
            {home.outstandingActions.length === 0 ? (
              ...
              <ul className="divide-y divide-[var(--border-subtle)]">
                {home.outstandingActions.map((task) => {
                  const project = task.projects as unknown as { id: string; name: string } | null;
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Card>
              ...
              {home.changeRequests.length === 0 ? (
                <EmptyState icon={FileText} title="None open" description="Nothing in progress." />
              ) : (
                <ul className="divide-y divide-[var(--border-subtle)]">
