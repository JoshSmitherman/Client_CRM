  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Support', href: '/portal/support' }, { label: ticket.reference }]}
        meta={
          <>
            <Badge tone={SUPPORT_STATUS_TONES[ticket.status]} dot>
              {SUPPORT_STATUS_LABELS[ticket.status]}
            </Badge>
            <Badge tone={URGENCY_TONES[ticket.urgency]}>{URGENCY_LABELS[ticket.urgency]}</Badge>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          ...
          <Card>
            <CardHeader title="Messages" description="Add anything else that might help us." />
            <CardBody>
              <CommentThread
                comments={comments}
